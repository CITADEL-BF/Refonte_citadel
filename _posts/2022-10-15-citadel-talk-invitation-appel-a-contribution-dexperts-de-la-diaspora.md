...
- actualites
- blog
coverImage: CITADEL-TALK-INVITATION-linkedIn.png
theme: Conférences
---

![](images/CITADEL-TALK-INVITATION-linkedIn-1024x576.png)
...
Vous êtes un chercheur ou un praticien en Intelligence Artificielle?

Votre expertise peut contribuer au développement de notre pays.

Vous êtes de la diaspora Burkinabè ?

Vous avez des travaux/résultats à  présenter sur l’IA appliquée à la SANTÉ & BIEN-ÊTRE , FINTECH & SÉCURITÉ, LANGUES & PATRIMOINE, AGRICULTURE & PASTORALISME, CONFIDENTIALITÉ & EXPLICABILITÉ, ÉNERGIE & CHANGEMENT CLIMATIQUE etc.

Alors CITADEL a besoin de vous pour accompagner le renforcement des capacités en IA du Burkina Faso.  
   
Chaque mois, CITADEL met à votre disposition un billet d’avion Aller-Retour pour un séjour dans le centre d’excellence. Soyez donc le premier à manifester votre disponibilité pour le mois qui vous convient.  
   
Votre calendrier ne vous permet pas de vous rendre sur place ? Nous avons pensé à vous, vous avez la possibilité de contribuer aux séminaires en ligne, il suffit de spécifier cela dans le formulaire.  
   
Hâtez-vous, Réservez votre place en cliquant le bouton suivant :

[POSTULER](https://bit.ly/citadel-talk-invitaion)
...
![](images/AxeDeRecherche-1024x753.png)
